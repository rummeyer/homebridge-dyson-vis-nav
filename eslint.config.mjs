...
export default defineConfig(
    ...
    ...tseslint.configs.stylisticTypeChecked,
    {
        ...
        // matter-clusters.ts mirrors the shape of matter.js's own cluster
        // definitions (e.g. PowerSource.BatChargeLevel.Ok) so that the ported
        // Dyson layer reads identically to its Matterbridge original. That
        // requires namespaces.
        files: ['**/matter-clusters.ts'],
        rules: {
